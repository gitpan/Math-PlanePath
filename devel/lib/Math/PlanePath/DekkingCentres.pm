...
This is a variation of a 5x5 self-similar curve by Dekking visiting the
centres of the square pattern and thus falling within 5x5 repeating blocks.
...
reversals that make the ends join.  For example N=75 to N=99 is the base
