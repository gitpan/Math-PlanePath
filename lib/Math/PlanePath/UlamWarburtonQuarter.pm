...
=for Test-Pari-DEFINE  rowwidth(depth) = 3^(hammingweight(depth+1) - 1)

=for Test-Pari  rowwidth(0) == 1   /* a */

=for Test-Pari  rowwidth(1) == 1   /* b */

=for Test-Pari  rowwidth(2) == 3   /* c */

=for Test-Pari  rowwidth(3) == 1   /* d */
...
=for Test-Pari-DEFINE  Ndepth(depth) = 1 + sum(i=0,depth-1, rowwidth(i))

=for Test-Pari-DEFINE  Nend(depth) = sum(i=0,depth, rowwidth(i))

=for Test-Pari  Nend(2) == 5
...
=for Test-Pari  vector(9,depth,my(depth=depth-1); Ndepth(depth)) == [1,2,3,6,7,10,13,22,23]

=for Test-Pari  vector(9,depth,my(depth=depth-1); rowwidth(depth)) == [1,1,3,1,3,3,9,1,3]

=for Test-Pari  vector(9,depth,my(depth=depth-1); Nend(depth)) == [1,2,5,6,9,12,21,22,25]
...
=for Test-Pari  Ndepth(3) == 6

=for Test-Pari  Ndepth(7) == 22
